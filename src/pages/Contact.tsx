      ...
      <div className="z-10 text-center">
        ...
        <div className="flex flex-col items-center gap-8 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <div className="flex flex-col items-center gap-3">
            <p className="text-gray-400 text-base md:text-lg">Here is my LinkedIn profile:</p>
            <a
              href="https://www.linkedin.com/in/pablo-nicolas-murillo/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 text-white bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 w-fit hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/10 transition-all"
            >
          ...
          <div className="flex flex-col items-center gap-3">
            <p className="text-gray-400 text-base md:text-lg">And you can contact me by email also:</p>
            <button
              onClick={handleCopy}
              className="flex items-center gap-3 text-white bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 w-fit hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/10 transition-all cursor-pointer text-sm md:text-base"
            >
